...
11. Redis helpers – `make redis-cache-list` prints all cached embeddings (`emb:*`), and `make redis-cache-clear` deletes them if you need a clean run.
